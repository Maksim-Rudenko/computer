'''Вычислить сумму квадратов чисел, не принадлежащих промежутку [X, Y) и количество
...
print('Сумма квадратов чисел, не принадлежащих промежутку [X, Y): {}'.format(result_sum))
